...
docker compose up -d
docker compose exec -u postgres postgres psql -v ON_ERROR_STOP=1 -c "REINDEX DATABASE postgres"
docker compose exec -u postgres postgres psql -v ON_ERROR_STOP=1 -c "ALTER DATABASE postgres REFRESH COLLATION VERSION;"
